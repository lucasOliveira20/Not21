...
public class InterfaceNot21 extends JFrame {
	...
	public InterfaceNot21() {
		...
		panel.add(lblC3J1);
		lblC3J1.setIcon(new ImageIcon(InterfaceNot21.class.getResource("/imagens/Default/Default.jpg")));
		...
		lblC2J1.setIcon(new ImageIcon(InterfaceNot21.class.getResource("/imagens/Default/Default.jpg")));
		lblC2J1.setBounds(152, 117, 114, 156);
		panel.add(lblC2J1);
		
		JLabel lblC1J1 = new JLabel("");
		lblC1J1.setIcon(new ImageIcon(InterfaceNot21.class.getResource("/imagens/Default/Default.jpg")));
		...
		lblC1J2.setIcon(new ImageIcon(InterfaceNot21.class.getResource("/imagens/Default/Default.jpg")));
		lblC1J2.setBounds(10, 115, 114, 156);
		panel_1.add(lblC1J2);
		
		JLabel lblC2J2 = new JLabel("");
		lblC2J2.setIcon(new ImageIcon(InterfaceNot21.class.getResource("/imagens/Default/Default.jpg")));
		lblC2J2.setBounds(152, 115, 114, 156);
		panel_1.add(lblC2J2);
		
		JLabel lblC3J2 = new JLabel("");
		lblC3J2.setIcon(new ImageIcon(InterfaceNot21.class.getResource("/imagens/Default/Default.jpg")));
		...
		lblDeckJogador2.setIcon(new ImageIcon(InterfaceNot21.class.getResource("/imagens/Default/DefaultM.jpg")));
	...
	public void iniciarPartidaRede(boolean comecoJogando) {
		...
		if (comecoJogando){
			...
			mesa.criarJogador(nomeOutroJogador);
			JOptionPane.showMessageDialog(this.getFrame(), "É sua vez, faça sua jogada");
		}else{
			mesa.criarJogador(nomeOutroJogador);
			mesa.criarJogador(this.nome);
			JOptionPane.showMessageDialog(this.getFrame(), "Espere o outro terminar a jogada...");
		}
	}
